...
metadata_f
# R4.0读取表不于默认为数据框
# metadata_f$State = as.factor(metadata_f$State)
# # 筛选"L"地点为训练集
# metadata_f = subset(metadata_f, DayE  %in% c("med"))
# 自己设置训练集和测试级
...
for(i in c("2Phylum","3Class","4Order","5Family","6Genus","8OTU0.02")){
  # i="5Family"
  set.seed(0)
  table_f = read.table(paste0("tax_pre_S_DH_",i,".txt"),header = T, row.names = 1)
