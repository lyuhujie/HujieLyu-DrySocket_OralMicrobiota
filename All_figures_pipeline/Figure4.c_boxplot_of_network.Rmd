...
# 保存图像到PDF文件
pdf("C:/16S/result/ggclusternet/connectors_boxplot_new.pdf", width = 12, height = 2.67)
grid.arrange(grobs = plot_list_connectors, widths = c(3, 22, 7), ncol = 3)
dev.off()
...
# 保存图像到PDF文件
pdf("C:/16S/result/ggclusternet/module_hubs_boxplot_new.pdf", width = 14, height = 2.67)
grid.arrange(grobs = plot_list_hubs, widths = c(9, 17, 9), ncol = 3)
dev.off()
