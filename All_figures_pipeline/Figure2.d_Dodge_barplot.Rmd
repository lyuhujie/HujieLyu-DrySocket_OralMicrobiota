...
```{r}
# 自定义配色
custom_colors <- c("D" = "#FBB4AE", "H" = "#B3CDE3", "I" = "#CCEBC5")
...
ggsave("C:/16S/result/faprotax2/bar_plot_new.png", plot = p, width = 6, height = 5)
# Save the plot as a PDF file
ggsave("C:/16S/result/faprotax2/bar_plot_new.pdf", plot = p, width = 6, height = 5)
